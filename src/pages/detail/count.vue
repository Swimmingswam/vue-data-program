<template>
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <v-chooser :selections="buyTypes" @on-change="changetype('zone', $event)"></v-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <v-selection :selections="districts" @on-change="changesel('period', $event)"></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      <my-dialog @on-close="hideErrDialog">
        支付失败！
      </my-dialog>
      <check-order  @on-close-check-dialog="hideCheckOrder" ></check-order>
  </div>
</template>
...
export default {
  ...
  data () {
   ...
   methods: {
        ...
        changesel:function(attr,val){
             this[attr] = val.label
        },
        changetype:function(attr,val){
             this[attr] = val.label
        },
